    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between">
        ...
        <div className="flex lg:hidden justify-end flex-1">
          <button
            ...
            className={`relative z-50 focus:outline-none p-2.5 rounded-full transition-all duration-300 ${
              isMobileMenuOpen
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <div className="absolute inset-0 bg-[#117DBE]/98 backdrop-blur-2xl" />

            {/* Content */}
            <div
              ref={menuRef}
              className="relative z-10 flex flex-col justify-center h-full px-8 max-w-md mx-auto"
            >
                ...
                {NavLinks.map((link, i) => (
                  ...
                  >
                    <NavLink
                      to={link.path}
                      className={({ isActive }) =>
                        `block py-3 text-3xl font-medium tracking-tight transition-all duration-300 ${
                          isActive
                            ? "text-white"
              ...
              >
                <NavLink
                  to="/membership"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white rounded-full text-[#111] font-bold text-base shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Join EWB-KNUST
                </NavLink>
